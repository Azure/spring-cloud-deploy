...
class DeploymentHelper {
    ...
    static deploy(client, params, sourceType, fileToUpload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let getResponse = yield client.deployments.get(params.resourceGroupName, params.serviceName, params.appName, params.deploymentName);
            ...
            let deploymentResource = Object.assign(Object.assign({}, getResponse), deploymentResourcePart);
